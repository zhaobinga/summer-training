		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog"  style="position:fixed; top:30%;">
		    <div class="modal-dialog" role="document">
		        <div class="modal-content">
		            ...
		            <div class="modal-body">
		               	<form action="/homework/logServlet" method="post" id="loginForm" class="form-horizontal" style="padding: 0px 20px;">
			...
			<table valign="middle" >
				<tr>
					...
					<td>
						<a href="#" onclick="changeImg()"><img id="imgObj" src="/homework/getCode" title="看不清，换一张"></a>
					</td>
				</tr>
			</table>
		                   ...
		                   <form action="/homework/AllServlet" method="post" onSubmit="return validate()" id="registeForm" class="form-horizontal" style="padding: 0px 20px;display: none;">
